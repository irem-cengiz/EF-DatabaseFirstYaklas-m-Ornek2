...
namespace EF_DatabaseFirstYaklasımıOrnek2.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<EnPahaliBesUrunWiev> EnPahaliBesUrunWievs { get; set; } = null!;
        public virtual DbSet<Invoice> Invoices { get; set; } = null!;
        public virtual DbSet<KritikSeviyeUrunBilgisi> KritikSeviyeUrunBilgisis { get; set; } = null!;
        public virtual DbSet<Ogretmenler> Ogretmenlers { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EnPahaliBesUrunWiev>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("EnPahaliBesUrunWiev");
            ...
            modelBuilder.Entity<KritikSeviyeUrunBilgisi>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("KritikSeviyeUrunBilgisi");
            ...
            modelBuilder.Entity<Ogretmenler>(entity =>
            {
                entity.HasKey(e => e.OgretmenId)
                    .HasName("PK__Ogretmen__27A3276F60E4744F");

                entity.ToTable("Ogretmenler");

                entity.Property(e => e.OgretmenAd).HasMaxLength(50);

                entity.Property(e => e.OgretmenSoyAd).HasMaxLength(50);
            });
